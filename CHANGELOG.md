...
- Updated citation metadata and author list.

## 0.1.0

- Initial reproducibility repository package.
- Added self-contained failure-map pipeline, environment files, and documentation placeholders.
